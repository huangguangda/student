			...
			<div
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="editQuestion.php"
							method='post'>
							...
							<div class="form-group">
								<h4>
									<label>选&nbsp;择&nbsp;科&nbsp;目：</label><label
										...
										name='subject' value='php' {$data['subject']== 'php'?'checked':''}/>php
									</label> <label class="checkbox-inline"> <input type="radio"
										name='subject' value='java' {$data['subject']== 'java'?'checked':''}/>
										java
									</label> <label class="checkbox-inline"> <input type="radio"
										name='subject' value='android' {$data['subject']== 'android'?'checked':''} />
										android
									</label>
								</h4>
							</div>
